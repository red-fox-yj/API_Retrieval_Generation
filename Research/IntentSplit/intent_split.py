...
def test_models(input_file, api_info=None):
    ...
    for model_name, model_path in models.items():
        # 测试标准 prompt 方案
        output_file_standard = f'results/intent_split_{model_name}.json'
...
# 调用测试函数
api_info = read_api_info('data/api_info.json')  # 从文件中读取 API 信息
test_models('data/muti_qas.json', api_info)